...
// import { DEFAULT_USER_API_BASE_URL } from '@/lib/constants'
...
// // const DEFAULT_USER_API_BASE_URL = 'http://localhost:8000/api/v1'
...
import type { AxiosInstance, AxiosRequestConfig, AxiosResponse, InternalAxiosRequestConfig } from 'axios'
import { clearAllTokens, getAccessToken, isAccessTokenExpiringSoon, setAccessToken } from '@/lib/token'
// ❌ 删除了顶部的 import { useAuthStore } from '@/stores/auth'，打破死循环
import { DEFAULT_USER_API_BASE_URL } from '@/lib/constants'
