  ...
  return (
    <div style={{ fontFamily: 'MiSans, sans-serif' }}>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-normal text-gray-900">获取API</h2>
          <p className="text-sm text-gray-500 mt-1">获取您的 API Key 以便调用接口</p>
        </div>
        <button
      ...
      <div className="p-6 border border-gray-100 rounded-lg bg-gray-50">
        <div className="flex items-center justify-between mb-4">
          <div>
            <p className="text-sm text-gray-500 mb-2">您的 API Key</p>
            <code
        ...
        <div className="flex items-center justify-between">
          <div className="text-sm text-gray-500">
            <p>创建时间：2026-01-15</p>
            <p className="mt-1">最后使用：2026-02-26</p>
          </div>
      ...
      {/* 使用说明 */}
      <div className="mt-8">
        <h3 className="text-lg font-normal text-gray-900 mb-4">使用说明</h3>
        <div className="space-y-4">
          <div className="flex items-start">
            ...
            <div>
              <p className="text-sm font-normal text-gray-900">在请求头中添加 API Key</p>
              <p className="text-sm text-gray-500 mt-1">使用 Authorization 头传递您的 API Key</p>
            </div>
          </div>
          <div className="flex items-start">
            ...
            <div>
              <p className="text-sm font-normal text-gray-900">保护您的 API Key</p>
              <p className="text-sm text-gray-500 mt-1">请勿在客户端代码中暴露您的 API Key</p>
            </div>
          </div>
          <div className="flex items-start">
            ...
            <div>
              <p className="text-sm font-normal text-gray-900">示例请求</p>
