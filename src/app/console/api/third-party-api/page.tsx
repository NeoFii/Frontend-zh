      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
        ...
        <div className="px-6 py-5 border-b border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-gray-900">第三方 API 管理</h2>
              <p className="text-sm text-gray-500 mt-1">管理您的第三方 AI 服务 API 密钥，确保服务正常运行。</p>
            </div>
            <div className="flex items-center space-x-2">
              <span className="px-3 py-1.5 bg-orange-50 text-orange-600 text-sm font-medium rounded-lg">
                {getConfiguredList().length} 个已配置
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="flex items-center mb-5">
            ...
            <h3 className="text-sm font-medium text-gray-900">选择服务商</h3>
          </div>
        ...
        <div className="p-6">
          <div className="flex items-center mb-5">
            ...
            <h3 className="text-sm font-medium text-gray-900">已配置的 API</h3>
          </div>
          ...
          {getConfiguredList().length > 0 ? (
            ...
            <div className="text-center py-12 px-4 border border-dashed border-gray-200 rounded-xl bg-gray-50/30">
              ...
              <p className="text-sm text-gray-500">暂无已配置的第三方 API</p>
              <p className="text-xs text-gray-400 mt-1">请在上方选择服务商进行配置</p>
            </div>
          )}
        </div>
      </div>
