        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-2">
              {step === 1 ? t('subtitleStep1') : t('subtitleStep2')}
            </p>
          </div>
          ...
          <form onSubmit={(e) => step === 1 ? sendCode(e) : handleResetPassword(e)} className="space-y-5">
              ...
              <>
                <div>
                  ...
                  <div className="flex space-x-3">
                    ...
                    >
                      {codeLoading ? t('sending') : codeCountdown > 0 ? `${codeCountdown}s` : t('resend')}
                    </button>
                  </div>
                </div>
            ...
            >
              {loading ? t('processing') : step === 1 ? t('sendCode') : t('resetPassword')}
            </button>
          </form>
